...
class Users(AbstractUser):
    ...
    profile_pic=models.JSONField(blank=True, null=True, default=dict)
    ...
    role=models.CharField(max_length=50,blank=True,null=True,default='Admin',choices=(('Admin','Admin'),('Supplier','Supplier'),('Customer','Customer'),('Staff','Staff'),('Super Admin','Super Admin')))
